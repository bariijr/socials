...
<aside x-show="sidebarOpen || window.innerWidth >= 1024" x-cloak
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        $links = [
            ...
            ['href' => '/members',                    'icon' => 'users',     'label' => __('nav.members', 'Members'),          'perm' => 'members.view'],
            ['href' => '/jumuiya',                    'icon' => 'community', 'label' => __('nav.jumuiya', 'Jumuiya'),          'perm' => 'jumuiya.view'],
            ['href' => '/accounting/transactions',    'icon' => 'cash',      'label' => __('nav.transactions', 'Transactions'),'perm' => 'accounting.view'],
            ['href' => '/campaigns',                  'icon' => 'heart',     'label' => __('nav.campaigns', 'Campaigns'),      'perm' => 'accounting.view'],
            ['href' => '/reports',                    'icon' => 'chart',     'label' => __('nav.reports', 'Reports'),          'perm' => 'reports.view'],
            ['href' => '/users',                      'icon' => 'shield',    'label' => __('nav.users', 'Users'),              'perm' => 'users.view'],
            ['href' => '/audit',                      'icon' => 'log',       'label' => __('nav.audit', 'Audit Log'),          'perm' => 'audit.view'],
            ['href' => '/settings',                   'icon' => 'cog',       'label' => __('nav.settings', 'Settings'),        'perm' => null],
        ];
        $icons = [
